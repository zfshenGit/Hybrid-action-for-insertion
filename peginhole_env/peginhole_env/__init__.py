...
register(id='peginhole_3prms-v3',entry_point='peginhole_env.envs.peginhole_3prms_v3:Peginhole_env')
register(id='peginhole_3prms-v4',entry_point='peginhole_env.envs.peginhole_3prms_v4:Peginhole_env')
